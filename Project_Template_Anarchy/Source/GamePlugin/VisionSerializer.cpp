...
void VisionSerializer::WriteVariableList(VTypedObject const *typedObj, VArchive& ar)
{
...
void VisionSerializer::ReadVariableList(VTypedObject *typedObj, VArchive /*const*/& ar)
{
  int numVars;
  ar >> numVars;
