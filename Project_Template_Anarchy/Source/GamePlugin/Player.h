...
class Player : public  SerializeBaseEntity_cl
{

float iHealth; // health recovery points
...
private:
  ...
  float m_fVal;                   // (serialized)
  hkvVec3 m_vPosition;            // (not serialized)
